...
<div class="btn-group" role="group" aria-label="Project actions">
	<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#warn-user-modal" data-project_title="<?php echo $project->title;?>" data-block_type="project" data-recipient_id="<?php echo $pu->user_id;?>" data-real_user_name="<?php echo $pu->real_user_name;?>"><span class="fa-stack fa-lg"><i class="fa fa-birthday-cake fa-stack-1x"></i><i class="fa fa-ban fa-stack-2x text-danger"></i></span> Заблокировать проект и вынести предупреждение</button>
	<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#warn-user-modal" data-project_title="<?php echo $project->title;?>" data-block_type="user" data-recipient_id="<?php echo $pu->user_id;?>" data-real_user_name="<?php echo $pu->real_user_name;?>"><span class="fa-stack fa-lg"><i class="fa fa-user fa-stack-1x"></i><i class="fa fa-ban fa-stack-2x text-danger"></i></span> Заблокировать пользователя и вынести предупреждение</button>
