...
var toolTipTemplateHtml = '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>';
...
var toolTipOptions = {
  ...
  selector: false,
  template: toolTipTemplateHtml,
  title: 'test title',
  trigger: 'hover',  // click | hover | focus | manual. You may pass multiple triggers; separate them with a space.
  viewport: { selector: 'body', padding: 0 } //Keeps the tooltip within the bounds of this element. Example: viewport: '#viewport' or { "selector": "#viewport", "padding": 0 }
...
$(".tooltip-demo").tooltip({selector:'[data-toggle="tooltip"]',container:"body", html: true});
