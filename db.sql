...
INSERT INTO `attaches` VALUES ('1af41c75e960087478ea67bf4965ae28','image',0,0,2,'c93354ae0ae578c6dd411849a6f93c83.jpg','',1494595383,3),('83c53f4e5d87a625f7b2a522006738e6','image',0,0,2,'fca9bf95d5dca9ff60ef80d943bcc753.jpg','',1494595383,3),('96d2212a5e23b0dc6a6002d389a846f1','image',0,0,2,'d61fc09bc10f43797d0f75e7eeff2ee6.jpg','',1494595383,3),('a179bc976f4fd62e5bf5864f83b67531','video',0,0,2,'','https://www.youtube.com/watch?v=aJaRUYE3C-I',1494595383,3),('c6d036dd415508d1728b4a90da2f4d1f','image',0,0,2,'5759843ba672493c00746bdf7001588b.jpg','',1494595383,3),('d6fda5963b5db01474c07e586d196bc8','video',5,0,0,'','https://youtu.be/RLYMIWrsahU',1494005463,1);
...
INSERT INTO `portfolio` VALUES (1,1,2,'Test port','ZZZ',1494005463,3,'',4),(2,1,1,'Photographer like a god','check this out',1494595383,3,'83c53f4e5d87a625f7b2a522006738e6',1);
...
INSERT INTO `project` VALUES (3,'title test','ТЕСТОВЫЙ\nПРоЕгТ!\n\n&lt;script&gt;alert(1)&lt;/script&gt;',0,1493108975,4,1,1493713663,1493713663,1493713663,2,5,1,0,0,7,0),(4,'&lt;script&gt;alert(1)&lt;/script&gt;','ТЕСТОВЫЙ\nПРоЕгТ!\n\n&lt;script&gt;alert(1)&lt;/script&gt;\n\n@!&amp;!!&lt;script&gt;alert(&quot;xss&quot;);&lt;/script&gt;',0,1493110514,4,1,1493715275,1493715275,1493715275,2,6,1,0,0,5,0),(5,'test for spb','test from weedo company',8600,1493720263,1,1,1495054800,1495054800,1495054800,1,1,2,0,0,9,0);
...
-- Dump completed on 2017-05-13 15:31:51
