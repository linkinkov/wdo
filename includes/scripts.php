...
<!-- WEEDO -->
<script type="text/javascript" src="<?php echo HOST;?>/js/wdo-functions.js"></script>
<script type="text/javascript" src="<?php echo HOST;?>/js/wdo-main.js"></script>
<script type="text/javascript" src="<?php echo HOST;?>/js/wdo-bindings.js"></script>
...
<script type="text/javascript" src="<?php echo HOST;?>/js/jquery.mask.min.js"></script>
